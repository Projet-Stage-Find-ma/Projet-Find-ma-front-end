...
export default function LostPhoneDetails(props)
{
    ...
    return <div className={styles.phoneDetailsContainer}>
        <div className={styles.PhoneDetailsInput}>
            ...
            <input className={styles.dataInputs} type="text" name="" id="" onChange={e => props.setImei(e.target.value)} />
        </div>

        <div className={styles.PhoneDetailsInput}>
            <label htmlFor="">Numéro de série:</label>
            <input className={styles.dataInputs} type="text" name="" id="" onChange={e => props.setSerialNumber(e.target.value)} />
        </div>
